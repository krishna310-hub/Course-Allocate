...
<body>
    ...
    <div>
        ...
        <br><br>
        <form action="{{route('department1')}}" method="post">
            @csrf
                <div>
                    <h2><label for="input" class="text">Department name:</label></h2>
                    <input type="text" placeholder="Enter the Department name" name="department" class="input">
