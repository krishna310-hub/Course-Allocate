...
<body>
    ...
    <div>
        <form action="{{route('course1')}}" method="post">
            @csrf
            <div>
                <br>
                <h1><label for="input" class="text">Course name:</label></h1>
                <input type="text" placeholder="Enter the Course name" name="course" class="input">
